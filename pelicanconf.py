...
PAGE_PATHS = ['pages']
ARTICLE_PATHS = ['posts']
STATIC_PATHS = ['images','extra','posts/seaborn_bar_plot_files','posts/micropython', 'extra/CNAME', 'code','posts/jupyter','posts/jupyterhub']  # removed this, see if any change 'code',
